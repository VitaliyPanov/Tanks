...
//     version 1.3.0
//     from Assets/Scripts/General/Services/InputControls.inputactions
//
...
namespace Tanks.General.Services.Input
{
    ...
    ""maps"": [
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""ToggleMinimap"",
                    ""type"": ""Button"",
                    ""id"": ""36e854f7-c3f1-4178-b55a-b4a8978bd987"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""6276ecb0-6555-4f20-ba42-df760b89dcea"",
                    ""path"": ""<Keyboard>/m"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""PC"",
    ...
    ""controlSchemes"": [
        ...
        },
        {
            ...
            m_Tank_ToggleMinimap = m_Tank.FindAction("ToggleMinimap", throwIfNotFound: true);
        }
        ...
        private readonly InputAction m_Tank_ToggleMinimap;
        public struct TankActions
        {
            ...
            public InputAction @ToggleMinimap => m_Wrapper.m_Tank_ToggleMinimap;
            ...
            public void SetCallbacks(ITankActions instance)
            {
                if (m_Wrapper.m_TankActionsCallbackInterface != null)
                {
                    ...
                    @ToggleMinimap.started -= m_Wrapper.m_TankActionsCallbackInterface.OnToggleMinimap;
                    @ToggleMinimap.performed -= m_Wrapper.m_TankActionsCallbackInterface.OnToggleMinimap;
                    @ToggleMinimap.canceled -= m_Wrapper.m_TankActionsCallbackInterface.OnToggleMinimap;
                }
