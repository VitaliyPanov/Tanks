...
public partial class InputContext {
    ...
    public Tanks.GameLogic.Components.Input.Time.DeltaTimeComponent deltaTime { get { return deltaTimeEntity.deltaTime; } }
    public bool hasDeltaTime { get { return deltaTimeEntity != null; } }

    public InputEntity SetDeltaTime(float newValue) {
        if (hasDeltaTime) {
            throw new Entitas.EntitasException("Could not set DeltaTime!\n" + this + " already has an entity with Tanks.GameLogic.Components.Input.Time.DeltaTimeComponent!",
...
public partial class InputEntity {
    ...
    public Tanks.GameLogic.Components.Input.Time.DeltaTimeComponent deltaTime { get { return (Tanks.GameLogic.Components.Input.Time.DeltaTimeComponent)GetComponent(InputComponentsLookup.DeltaTime); } }
    ...
    public void AddDeltaTime(float newValue) {
        ...
        var component = (Tanks.GameLogic.Components.Input.Time.DeltaTimeComponent)CreateComponent(index, typeof(Tanks.GameLogic.Components.Input.Time.DeltaTimeComponent));
