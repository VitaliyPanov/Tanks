...
public sealed class GameEventSystems : Feature {
    ...
    public GameEventSystems(Contexts contexts) {
        Add(new HealthDamageEventSystem(contexts)); // priority: 0
        Add(new MovableEventSystem(contexts)); // priority: 0
        Add(new MovableRemovedEventSystem(contexts)); // priority: 0
        Add(new WeaponActivateRemovedEventSystem(contexts)); // priority: 0
        Add(new WeaponLaunchingEventSystem(contexts)); // priority: 0
    }
}
